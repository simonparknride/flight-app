# Flight List Factory - Streamlit app (Modified with Specific Spacing)
# - ONE-PAGE DOCX (two-column): Spacing Before/After set to 2.2pt
...
# --- Existing TWO-PAGE DOCX (Space 0pt) ---
    ...
    def add_inner_table(cell, recs, start_index=0):
        ...
        for i, r in enumerate(recs):
            ...
            for j, val in enumerate(vals):
                ...
                # --- One-Page 핵심 설정: 2.2pt 적용 ---
                para.paragraph_format.space_before = para.paragraph_format.space_after = Pt(2.2)
